...
var usercontact = {
    ...
    getUserContactCallback: function(data){
        ...
        if (data.success == 'true'){
            me.model.set('real_name', result['real_name']);
            me.model.set('address', result['address']);
            me.model.set('mobile', result['mobile']);
...
bui.Action.addModule(usercontact);
//派生自 bui.Action
bui.Action.derive(usercontact);
//bui.derive(usercontact, bui.Action);
